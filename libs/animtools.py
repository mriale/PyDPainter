...
def init_animtoolbar(config_in):
    ...
    numtools=9
    numsubtools=3
    h = minitools_image.get_height()//numsubtools + 1
    ...
    minitoolbar.add_grid((0,0,w,11*scaleY), numtools, 1, attr_list=[
...
def draw_animtoolbar(screen_rgb, rect):
    ...
    if config.animtoolbar.visible:
        ...
        pygame.draw.rect(screen_rgb, (160,160,160), (rect[0], rect[1]+py*2, rect[2], rect[3]))
