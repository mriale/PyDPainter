...
tiptext["square2"]   = ["2x2 pixel square"]
tiptext["square3"]   = ["3x3 pixel square"]
tiptext["square4"]   = ["4x4 pixel square"]
tiptext["square5"]   = ["5x5 pixel square"]
tiptext["spray2"]    = ["Small spray brush"]
tiptext["spray3"]    = ["Large spray brush"]

tiptext["expand"]    = ["Expand or contract mini toolbar [\\]"]
tiptext["help"]      = ["Toogle help bubbles on or off"]
tiptext["scale"]     = ["Scale window to be larger or smaller [Ctrl-+]/[Ctrl--]"]
tiptext["fullscreen"]= ["Toggle full-screen mode [F11]"]
tiptext["scanlines"] = ["Toggle retro CRT scanline simulation [F12]"]
